...
<div className={`p-[15px] col-span-2 ${order==1?"order-2":"order-1"	}`}>
...
<div className={`py-[30px] px-[10px]   ${order==1?"order-1":"order-2"	}`}>
    <img src="https://saharamkt.com/wp-content/uploads/2020/01/Restaurant_ed3850622aa2ae55b80492a7fa935d02.jpg" alt="" className='shadow w-full ' data-aos="fade-right" data-aos-duration="3000"/>
</div>
</div>
    </div>
  </div>

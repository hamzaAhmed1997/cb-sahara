  ...
  return (
    <div className="w-full my-[30px]">
      <div className=" max-w-[1140px] w-full mx-auto px-4">
        <div className="w-full mx-auto grid grid-cols-1 gap-4 lg:grid-cols-3">
          {data.map((item, index) => {
            return (
              <div key={index}>
                <div class="flip-cards w-[379px]">
                  <div class="flip-cards-inner p-[10px">
                    ...
                    <div class="flip-cards-back text-center p-[35px] flex flex-col justify-center bg-[#6A0000] text-[#ffff]">
                      <h2 className="mb-[20px]">{item.name}</h2>
